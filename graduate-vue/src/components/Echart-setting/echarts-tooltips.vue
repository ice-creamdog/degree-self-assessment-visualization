<template>
  <div class="tooltips-setting">
    <el-form inline="true" v-model="toolTips" size="small">
      ...
      <el-form-item label="axisPointer">
        <el-form inline="true" v-model="toolTips.axisPointer" size="small">
          ...
          <el-form-item label="lineStyle" v-if="toolTips.axisPointer.type === 'line'">
            <line-style />
          </el-form-item>
          <el-form-item label="shadowStyle" v-else-if="toolTips.axisPointer.type === 'shadow'">
          ...
          <el-form-item label="crossStyle" v-else-if="toolTips.axisPointer.type === 'cross'">
            <line-style />
          </el-form-item>
        </el-form>
      </el-form-item>
